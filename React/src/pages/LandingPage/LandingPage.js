    ...
    <section className={styles.features}>
        ...
        <div className={styles.teamGrid}>
            ...
            <div className={styles.teamContact}>
                ...
                <a href="https://linkedin.com/in/reindelacruz" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
            </div>
            ...
            <div className={styles.teamCard}>
            <div className={styles.teamPhoto}>
                <img src="/images/team/member4.jpg" alt="Sarah Wilson" />
            </div>
            <h3>Andrei Tamse</h3>
            <p className={styles.teamRole}>Developer</p>
            <div className={styles.teamContact}>
                <a href="mailto:andrei_tamse@dlsu.edu.ph">andrei_tamse@dlsu.edu.ph</a>
                <a href="https://linkedin.com/in/sarahwilson" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
            </div>
            ...
            <div className={styles.teamCard}>
            <div className={styles.teamPhoto}>
                <img src="/images/team/member5.jpg" alt="Alex Brown" />
            </div>
            <h3>Rafael Hugo</h3>
            ...
            <div className={styles.teamContact}>
                ...
                <a href="https://linkedin.com/in/alexbrown" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
            </div>
            ...
            <div className={styles.teamContact}>
                ...
                <a href="https://linkedin.com/in/emilydavis" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
            </div>

            <div className={styles.teamCard}>
            <div className={styles.teamPhoto}>
                <img src="/images/team/member7.jpg" alt="David Chen" />
            </div>
            <h3>Joshua Laxa</h3>
            <p className={styles.teamRole}>Lead Analyst</p>
            <div className={styles.teamContact}>
                <a href="mailto:joshua_laxa@dlsu.edu.ph">joshua_laxa@dlsu.edu.ph</a>
                <a href="https://linkedin.com/in/davidchen" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
            </div>
        </div>
        </div>
